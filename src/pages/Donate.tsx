...
function Donate() {
  ...
  const needs = [
    {
      ...
      urgency: "High",
      description: "30+ elderly people need daily care, food, and medical assistance",
    ...
    },
    {
      ...
      urgency: "Medium",
      description: "50+ street children need education materials and daily meals",
    ...
    },
    {
      ...
      urgency: "Critical",
      description: "200+ families affected by floods need immediate shelter and supplies",
    ...
    },
    {
      ...
      urgency: "High",
      description: "Urgent need for ventilators and medical supplies in rural hospital",
    ...
    },
    {
      ...
      category: "Education",
      urgency: "Medium",
      description: "Books, notebooks, and stationery needed for 100+ underprivileged students",
    ...
    },
    {
      ...
      urgency: "High",
      description: "Installing water purification systems in drought-affected villages",
    ...
    },
    {
      ...
      category: "Child Welfare",
      urgency: "Critical",
      description: "Complete renovation and supplies for 80+ orphaned children",
    ...
    },
    {
      ...
      category: "Health & Medical",
      urgency: "High",
      description: "Counseling services and awareness campaigns for mental health",
    ...
    },
    {
      ...
      category: "Education",
      urgency: "Medium",
      description: "Sports gear and playground equipment for underfunded schools",
  ...
  const filteredAndSortedNeeds = useMemo(() => {
    let filtered = needs.filter((need) => {
      ...
      const matchesCategory = selectedCategories.length === 0 || selectedCategories.includes(need.category);
      const matchesUrgency = selectedUrgencies.length === 0 || selectedUrgencies.includes(need.urgency);
      const matchesLocation = selectedLocations.length === 0 || selectedLocations.includes(need.location);
    ...
    return filtered;
  }, [searchTerm, sortOption, selectedCategories, selectedUrgencies, selectedLocations]);
      ...
      <Sheet>
        ...
        <SheetContent side="top" className="h-auto max-h-[90vh] overflow-y-auto">
          ...
          <div className="mt-6 space-y-6">
            {/* Filter Summary */}
            {(selectedCategories.length + selectedUrgencies.length + selectedLocations.length > 0 || searchTerm) && (
              <div className="bg-blue-50 p-3 rounded-lg border border-blue-200">
                <p className="text-sm text-blue-700 font-medium">Active Filters: {selectedCategories.length + selectedUrgencies.length + selectedLocations.length + (searchTerm ? 1 : 0)}</p>
              </div>
            )}
            {/* Search */}
        ...
        <div className="max-w-6xl mx-auto">
                ...
                <CardContent>
                  ...
                  <div className="mb-4">
                    <div className="flex justify-between items-center mb-2">
                      ...
                      <span className="text-sm text-gray-600">{need.funded}%</span>
                    </div>
          ...
          {filteredAndSortedNeeds.length === 0 && (
            <div className="text-center py-12">
              <p className="text-gray-500 text-lg">No needs found matching your search.</p>
            </div>
          )}
        </div>
      </div>
